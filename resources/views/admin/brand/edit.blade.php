                  ...
                  <div class="row mg-b-25">
                    <div class="col-lg-3">
                       <form action="{{ route('update.brand') }}" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="brand_name" value="{{ $brand->brand_name }}" placeholder="Enter Brand name">
                    ...
                    <div class="col-lg-3">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="status" value="{{ $brand->status }}">
                      </div>
                    </div><!-- col-4 -->
                  </form>
